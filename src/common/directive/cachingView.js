...
angular.module('CachingView',['Service'])
    .directive('CachingView', ngCachingViewFactory)
    .directive('CachingView', ngViewFillContentFactory) ;
    ...
    return {
        ...
        link:  function(scope, $element, attr, ctrl, $transclude) {
            ...
            function disconnectScope(scope){
                ...
                scope.$broadcast('$scopeDisconnected');
            }
            function reconnectScope(scope){
                ...
                scope.$broadcast('$scopeReconnected');
            }
            ...
            function changeView(view){
                ...
                if (currentElement){
                    ...
                    if(newIndex > oldIndex){
                        ...
                        currentElement.scope().$broadcast('enterBackground');
